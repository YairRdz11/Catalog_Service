    ...
    public class ProductServiceTests
{
 ...
 var productDTO = new ProductDTO
   ...
   _mockProductRepository.Setup(r => r.DoesItemExistByNameAsync(productDTO.Name))
          .ReturnsAsync(false);

     _mockCategoryRepository.Setup(r => r.GetByIdAsync(categoryId))
.ReturnsAsync(categoryDTO);

   _mockProductRepository.Setup(r => r.CreateAsync(It.IsAny<ProductDTO>()))
...
[Fact]
  ...
  new ProductDTO { Id = Guid.NewGuid(), Name = "Laptop", CategoryId = category1Id },
    ...
    var category2 = new CategoryDTO { Id = category2Id, Name = "Books" };
     ...
     _mockProductRepository.Setup(r => r.GetListAsync())
        .ReturnsAsync(products);

   _mockCategoryRepository.Setup(r => r.GetByIdAsync(category1Id))
   .ReturnsAsync(category1);

          _mockCategoryRepository.Setup(r => r.GetByIdAsync(category2Id))
...
[Fact]
 ...
 result.Should().BeEmpty();
  ...
  var category = new CategoryDTO { Id = categoryId, Name = "Electronics" };
   ...
   // Assert
        result.Should().HaveCount(3);
    // Note: This highlights a potential performance issue - calling GetByIdAsync for each product
         // even when they share the same category
 ...
 _mockCategoryRepository.Setup(r => r.GetByIdAsync(categoryId))
            ...
            _mockProductRepository.Setup(r => r.UpdateAsync(It.IsAny<ProductDTO>()))
...
var categoryId = Guid.NewGuid();
  ...
  Id = productId,
    ...
    Description = "Test",
     ...
     // Act
            // Note: UpdateAsync has a bug - it doesn't await ValidateProduct
        ...
        public async Task DeleteAsync_WithValidId_ShouldReturnDeletedProduct()
   {
    ...
    _mockProductRepository.Setup(r => r.GetByIdAsync(productId))
     .ReturnsAsync(deletedProduct);
            ...
            _mockProductRepository.Setup(r => r.DeleteAsync(productId))
     .ReturnsAsync(deletedProduct);
...
var categoryId = Guid.NewGuid();
 ...
 Price = 100m,
    ...
    _mockProductRepository.Setup(r => r.DoesItemExistByNameAsync(It.IsAny<string>()))
  .ReturnsAsync(false);
